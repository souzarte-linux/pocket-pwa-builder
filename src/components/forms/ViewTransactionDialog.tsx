...
import { Pencil, Calendar, Clock, MapPin, Package, CreditCard, Fuel, Wrench, UtensilsCrossed, FileText, CheckCircle2, AlertCircle, Building2, Gauge, Hash } from 'lucide-react';
      ...
      <DialogContent className="max-w-lg bg-surface border border-border/40 rounded-2xl p-6 max-h-[90vh] overflow-y-auto z-50">
        <DialogHeader className="flex flex-row items-center justify-between border-b border-border/20 pb-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary/10 text-primary hover:bg-primary/20 text-xs font-bold transition active:scale-95 shrink-0"
          >
